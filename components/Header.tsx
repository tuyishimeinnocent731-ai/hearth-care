...
const Header: React.FC<HeaderProps> = ({ searchQuery, onSearchChange, onToggleMobileNav }) => {
  ...
  return (
    <header className="bg-white border-b border-gray-200 fixed top-0 left-0 right-0 z-20 lg:left-72 lg:right-80">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <button
              ...
              className="lg:hidden mr-3 p-2 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
            >
